    ...
    return {
        ...
        placements: document.placements
            ...
            .map(placement => ({
                ...
                publicationStatus: placement.publication_status,
                publishFrom: placement.publish_from,
                publishUntil: placement.publish_until,
                displayPublishedAt: placement.display_published_at,
                publicationRevision: placement.publication_revision,
